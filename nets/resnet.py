...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.finel_fc = nn.Linear(512 * block.expansion, num_seg_classes)
...
if __name__ == '__main__':
    import pdb, os
    pth_dir = "../external/pretrain/resnet_200.pth"
    new_layer_names = ['upsample1', 'cmp_layer3', 'upsample2', 'cmp_layer2', 'upsample3', 'cmp_layer1', 'upsample4', 'cmp_conv1',
     'conv_seg']
    os.environ["CUDA_VISIBLE_DEVICES"] = '1'
    x = torch.rand((1, 1, 96, 112, 64)).cuda()
    model = resnet200(sample_input_W=96,
                      sample_input_H=112,
                      sample_input_D=64,

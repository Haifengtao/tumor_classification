...
__C.general = {}
__C.general.log_path = "../cpts/cls/baseline/model"
__C.general.model_path = "../cpts/cls/baseline/model"
...
__C.train = {}
__C.train.load_model = None  # "../cpts/cls/baseline/model/340_model.pth"
...
__C.logger = {}
__C.logger.title = []
__C.logger.save_path = "/home1/zhaobt/PycharmProjects/tumor_cls/models/cls/baseline/"
...
__C.test = {}
__C.test.model = "../cpts/cls/baseline/model/best_model.pth"
__C.test.save_dir = "../cpts/cls/baseline/res.json"

...
__C.general = {}
__C.general.log_path = "../cpts/cls/dropout/model"
__C.general.model_path = "../cpts/cls/dropout/model"
...
__C.train = {}
__C.train.load_model =None  # "../cpts/cls/dropout/model/155_model.pth"
...
__C.logger = {}
__C.logger.title = []
__C.logger.save_path = "/home1/zhaobt/PycharmProjects/tumor_cls/models/cls/dropout/"
...
__C.test = {}
__C.test.model = "../cpts/cls/dropout/model/505_model.pth"
__C.test.save_dir = "../cpts/cls/dropout/res.json"
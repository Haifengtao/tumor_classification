...
__C.general = {}
__C.general.log_path = "../cpts/baseline/model_2"
__C.general.model_path = "../cpts/baseline/model_2"
...
weight = torch.tensor([0.05, 1]).cuda()
__C.loss.losses = [Losses.DiceLoss(), torch.nn.CrossEntropyLoss(weight=weight, reduction="mean")]

__C.logger = {}
__C.logger.title = []
__C.logger.save_path = "../models/baseline"
__C.logger.save_name = "train_log_2.csv"
__C.logger.file_name = []

__C.infer = {}
__C.infer.data_log="/share/inspurStorage/home1/zhaobt/data/tumor_classification/preprocessed_1/dataset2_summary_v2.csv"
__C.infer.save_suffix = "_pred_mask_baseline.nii.gz"
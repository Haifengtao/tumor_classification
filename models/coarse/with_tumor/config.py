...
__C.general = {}
__C.general.log_path = "../cpts/with_tumor/model"
__C.general.model_path = "../cpts/with_tumor/model"
...
__C.logger = {}
__C.logger.title = []
__C.logger.save_path = "../models/coarse/with_tumor"
__C.logger.save_name = "train_log.csv"
__C.logger.file_name = []


__C.test = {}
__C.test.model = "/home1/zhaobt/PycharmProjects/tumor_cls/cpts/with_tumor/model/best_model.pth"


__C.infer = {}
__C.infer.data_log="/share/inspurStorage/home1/zhaobt/data/tumor_classification/preprocessed_1/dataset1_summary_v1.csv"
__C.infer.save_suffix = "_pred_mask_baseline_tumor.nii.gz"